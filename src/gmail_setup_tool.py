    ...
    *,
    ...
    return "\n".join(
        [
            ...
            f"2. Enable Gmail API: `https://console.developers.google.com/apis/api/gmail.googleapis.com/overview?project={project_id}`.",
            "3. Configure OAuth consent screen.",
            f"4. Create an OAuth client named `{oauth_client_name}`.",
            f"5. Add redirect URI `{redirect_uri}`.",
