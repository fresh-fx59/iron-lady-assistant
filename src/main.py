...
async def main() -> None:
    ...
    await bot.set_my_commands([
        ...
        BotCommand(command="gmail_connect", description="Start gateway Gmail OAuth connect"),
        BotCommand(command="gmail_status", description="Show gateway Gmail account status"),
        BotCommand(command="gmail_account", description="Show Gmail account link status"),
        BotCommand(command="gmail_search", description="Search Gmail messages"),
        BotCommand(command="gmail_read", description="Read Gmail message"),
        BotCommand(command="gmail_trash", description="Move Gmail message to trash"),
        BotCommand(command="gmail_delete", description="Delete Gmail message"),
        BotCommand(command="gmail_send", description="Send Gmail message"),
